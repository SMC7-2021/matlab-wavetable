...
% Sine wavetable.
wt1 = sin(linspace(0, 2 * pi, wtLength)');
% Square wavetable.
% NB, calculating points all the way to 2*pi results in a final point with 
% amplitude +1.
wt2 = square(linspace(0, (2 * pi) - 1/wtLength, wtLength)');
